...
public class AnalysisReportController {
    ...
    private final AnalysisReportTotalService analysisReportTotalService;

    @GetMapping("/total")
    @Operation(summary = "분석 리포트 전체 탭 조회", description = "선택 월 기준 전체 분석 리포트 통계와 차트 데이터를 조회합니다.")
    @ApiResponses({
    ...
    public ResponseEntity<ApiResponse<AnalysisReportTotalResponse>> getTotalReport(
        ...
        AnalysisReportTotalResponse response = analysisReportTotalService.getTotalReport(storeId, month);
